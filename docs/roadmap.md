...
- 已验证基础：public ID、Account/Event 兼容迁移、默认发布+文本证据、Event 文件上传、demo captcha、归档导出/预览/确认导入、处罚列表、动态 Auth Shell、submission 验证码 purpose。
- 仍待完成：发布请求多文件二进制事务、处罚申诉自助流、旧 Case API 弃用窗口、Phase 12 完整 design token/Playwright。
