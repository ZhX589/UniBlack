...
> **Canonical model (Phase 13, 2026-07):** Subject → Account → Event → Evidence.  
> Legacy Identifier / Case / Submission remain only for the compatibility window ending **2026-12-31** (see `docs/api/case-event-migration.md` and migrations `000006`–`000011`).  
> This document retains the historical Phase 1 ER narrative below for migration context; **do not treat Identifier/Case as the write path for new features.**

## 实体关系概览（Canonical + Legacy）
...
└─────────────┘     └─────────────┘     └─────────────┘
  ...
  Canonical (Phase 13)                    Legacy (compat → Sunset)
┌─────────────┐     ┌─────────────┐      ┌─────────────┐
